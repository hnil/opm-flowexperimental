 ...
 */
#ifndef EWOMS_BLACK_OIL_INTENSIVE_QUANTITIES_ECL_HH
#define EWOMS_BLACK_OIL_INTENSIVE_QUANTITIES_ECL_HH
...
public:
                ...
                const OilPvtT& oilpvt)
    {
        ...
        {
            OPM_TIMEBLOCK_LOCAL(AllPVTVistosity,Opm::Subsystem::Props);
