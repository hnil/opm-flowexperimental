...
//                if (FluidSystem::enableVaporizedOil()) {
                Opm::SegmentIndex segIdx = gaspvt.saturatedOilVaporizationFactorTable()[pvtRegionIdx].findSegmentIndex(p,/*extrapolate=*/true);
...
//                }
            ...
            if (FluidSystem::phaseIsActive(oilPhaseIdx)) {
                ...
                Opm::SegmentIndex segIdx = oilpvt.saturatedGasDissolutionFactorTable()[pvtRegionIdx].findSegmentIndex(p,/*extrapolate=*/true);
            ...
            // calculatstd::array<Evaluation, numPhases> mobility;
            // for (unsigned phaseIdx = 0; phaseIdx < numPhases; ++phaseIdx) {
            //     if (FluidSystem::phaseIsActive(phaseIdx)) {
